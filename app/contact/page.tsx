            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  ...
                  programs? We'd love to hear from you and help you achieve your
                  fitness goals.
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-gray-600 text-lg leading-relaxed mb-8">
                        ...
                        Reach out to us for personalized fitness advice, program
                        recommendations, or any questions you might have.
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">sunny@fitnesspro.com</p>
                          <p className="text-gray-600">fitness@pro.com</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Aaarry Colony, Main Pump Street
                          </p>
                          <p className="text-gray-600">
                            Goregaon East, Mumbai, MH 12345
                          </p>
                        </div>
                      </div>
                    </div>
