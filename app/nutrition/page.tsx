// fully api integerated- now recoeds are visisble in BMI history section.
"use client";
...
interface BMIData {
  _id?: string; // Add _id for database records
  weight: number;
  weightKg: number;
  height: number;
  heightM: number;
...
export default function BMITracker() {
  ...
  const getDietPlan = (bmiValue: number): DietPlan => {
    const calories = calculateCalories(
      bmiValue,
      parseFloat(weight) * (unit === "metric" ? 1 : 0.453592)
    );
    ...
    if (bmiValue < 18.5) {
      return {
        ...
        exerciseRecommendation:
          "Strength training 3-4 times per week, limit cardio",
      };
    } else if (bmiValue < 25) {
      return {
        ...
        exerciseRecommendation:
          "Mix of cardio and strength training, 4-5 times per week",
      };
    } else if (bmiValue < 30) {
      return {
        ...
        exerciseRecommendation:
          "Cardio 5 times per week + strength training 2-3 times",
      };
    } else {
      return {
        ...
        exerciseRecommendation:
          "Daily cardio + strength training 3-4 times per week",
      };
    }
  };
  ...
  const calculateCalories = (bmiValue: number, weightKg: number) => {
    ...
    if (gender === "male") {
      bmr =
        10 * weightKg +
        6.25 * (parseFloat(height) * (unit === "metric" ? 1 : 2.54)) -
        5 * ageNum +
        5;
    } else {
      bmr =
      ...
      <div className="w-full max-w-6xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">
                BMI Tracker & Diet Planner
              </h1>
              <p className="text-blue-100 text-sm">
                Monitor your BMI and get personalized diet recommendations
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="mt-6 p-4 bg-white rounded-lg border border-gray-200">
                  ...
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    <div className="text-xs text-gray-600 text-center">
                      <strong>BMI Categories:</strong> Underweight (&lt;18.5) •
                      ...
                      <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <div className="space-y-4">
                              {Object.entries(plan.mealPlan).map(
                                ([meal, options]) => (
                                  <div
                                    key={meal}
                        ...
                        <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                          <p className="text-xs text-yellow-800">
                            <strong>Disclaimer:</strong> This is a general diet
                            plan based on your BMI. Please consult with a
                            healthcare provider or registered dietitian for
                            personalized advice, especially if you have health
            ...
            <div
              className={
                bmi && showDietPlan ? "xl:col-span-3" : "xl:col-span-2"
              }
            >
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-semibold ${
                                getBMICategory(record.bmi).bgColor
                          ...
                          <div className="text-sm text-gray-600">
                            ...
                            {record.unit === "metric" ? "cm" : "in"} • Weight:{" "}
                            {record.weight}{" "}
